...
Nous nous sommes répartis le travail entre nous trois, avec chacun ses taches:
\begin{itemize}
    \item Elouan s'est occupé du diagramme de Cas d'utilisation et du diagramme d'état-transition.
    \item Killian s'est occupé du diagramme de classe et du diagramme de séquence ainsi que du début de la redaction du rapport.
    \item Aymeric s'est occupé du diagramme d'objet et de la fin de la redaction du rapport.
\end{itemize}
