...
L'objectif du diagramme d'objet est de modéliser un exemple concret de notre jeu. Nous avons choisi de montrer le comportement de notre jeu en montrant le comportement d'une partie avec 2 tuiles sur le plateau. Elle-même composé de 4 Zone chacune. Chaque Zone possède un biome, d'une couleur et d'un nom.\\
...
\end{figure}
L'objectif du diagramme d'état-transition est de montrer les différents états que peut prendre notre jeu au fur et a mesure du déroulement de la partie. Nous avons donc modéliser les differentes étapes de la partie de l'initialisation au fonctionnement de la partie.
\newpage
